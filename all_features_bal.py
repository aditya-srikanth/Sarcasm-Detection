...
'''Sparse Features'''
lieb = io.mmread('./lieb/lieb_balanced_csr.mtx')
gonz = io.mmread('./gonzalez/gonz_balanced_csr.mtx')
gonz = gonz.tocsc()
...
stats_path = "./new_stats/ALL_BASE_BAL"
...
print(all_feat.shape[1]-lieb.shape[1])
